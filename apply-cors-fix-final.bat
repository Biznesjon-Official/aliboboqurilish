@echo off
echo Applying final CORS fix to Nginx configuration...

REM Copy the fixed Nginx configuration to the VPS
echo Copying Nginx configuration to VPS...
scp nginx-cors-fix-final.conf root@45.92.173.33:/etc/nginx/sites-available/alibobo
