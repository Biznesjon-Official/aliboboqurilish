@echo off
echo Applying simple CORS fix to Nginx configuration...

REM Copy the simple Nginx configuration to the VPS
echo Copying Nginx configuration to VPS...
scp nginx-cors-fix-simple.conf root@45.92.173.33:/etc/nginx/sites-available/alibobo
