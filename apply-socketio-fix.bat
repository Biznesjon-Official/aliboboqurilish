@echo off
echo Applying Socket.IO fix to Nginx configuration...

REM Copy the Socket.IO fix Nginx configuration to the VPS
echo Copying Nginx configuration to VPS...
scp nginx-socketio-fix.conf root@45.92.173.33:/etc/nginx/sites-available/alibobo
